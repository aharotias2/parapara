...
namespace Tatap {
    public class Window : Gtk.Window {
        ...
        public Tatap.Image image { get; private set; }
        private Revealer message_revealer;
        private Label message_label;
        private Stack stack;
        private Granite.Widgets.Welcome welcome;
        private Tatap.ToolBar toolbar;
        ...
        public void open_file(string filename) {
            ...
            try {
                ...
                if (old_file_dir == null || old_file_dir != new_file_dir) {
                    ...
                    file_list = new Tatap.FileList(image.fileref.get_parent().get_path());
